...
div = 20;             %division for which loop runs
...
Num_ord = 9;                                  % number for the highest diffraction order
...
%       disp(widi);
      ...
      pk = findpeaks(Tran,'MinPeakHeight',0.3,'MinPeakWidth',10,'MaxPeakWidth',100,'MinPeakProminence',0.08,'MinPeakDistance',10,'Threshold',0.01,'WidthReference','halfheight')
...
[pks,locs] = findpeaks(Tran,'MinPeakHeight',0.25,'MaxPeakWidth',100,'MinPeakProminence',0.05,'MinPeakDistance',10,'WidthReference','halfheight')
si = size(locs);
if(si(2)<2)
